...
@section ('contenido')
	<div class="row">
		...
		<div class="row">
			...
			<div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
				<div class="form-group">
					<label for="num_comprobante">Numero de Documento</label>
					<input type="text" name="num_comprobante" required value="{{old('num_comprobante')}}" class="form-control " required placeholder="Numero de Comprobante">
				</div>
			</div>
			</div>
...
@push('script-nuevo')
	...
	function agregar()
	{
		...
		{
			alert("Error En El Detalle Compra,Revise los datos del Articulo");
		}
	}
